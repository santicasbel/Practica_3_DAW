    ...
    if(filter_input(INPUT_POST, 'opcion') != 1 && filter_input(INPUT_POST, 'opcion') != NULL){
        ...
        if (mysqli_connect_error()) {
            ...
            if(filter_input(INPUT_POST, 'opcion') == 2){
                ...
                $resultado = mysqli_query($recurso, "SELECT id_pedido,nombre_usuario,nombre_producto,precio,cantidad, envio, fecha FROM pedidos WHERE envio = 0 AND nombre_producto = '" .$producto. "';");
            }
