<html>
    ...
    if(filter_input(INPUT_POST, 'opcion') != 1 && filter_input(INPUT_POST, 'opcion') != NULL){
        ...
        if (mysqli_connect_error()) {
            ...
            $resultado = mysqli_query($recurso, "SELECT id_producto,nombre_producto,precio,descripcion,stock,alta FROM productos WHERE nombre_producto like '%" .$nombre_producto. "%';");
        }
